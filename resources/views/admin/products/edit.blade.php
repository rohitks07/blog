...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active" aria-current="page">Edit Products</a></li>
@endsection
@section('content')
        ...
        <div class="col-lg-9">
            <div class="form-group row">
                ...
                <div class="col-lg-12">
                    ...
                    <p class="small">
                        {{config('app.url')}}<span id="url">{{$product->slug}}</span>
            ...
            <ul class="list-group row">
                ...
                <li class="list-group-item">
                    ...
                    <div class="img-thumbnail text-center">
                        <img src="@if(isset($product))
                                    {{url('')}}/{{$product->thumbnail}}
                                  @else
                                    {{asset('public/images/no-thumbnail.jpeg')}}
                                  @endif"
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text">
                                    <input id="featured" type="checkbox" name="featured" value="" @if($product->featured == 1) {{'checked'}} @endif>
                                </span>
                            </div>
                ...
                @php
                    $ids = (isset($product->catagories) && ($product->catagories->count() > 0))  ?  Arr::pluck($product->catagories, 'id') : null;
                @endphp
